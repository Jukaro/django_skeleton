...
export class Navbar extends Component {
	...
	async test() {
		...
		if (userInfo != null)
		{
			...
			this.querySelector("#search-user").addEventListener("input", (e) => {
				...
				<div class="d-flex align-items-center justify-content-center">
					...
					<div class="px-2">
						...
						<div class="form-outline position-relative">
							<input id="search-user" type="text" class="form-control ps-5 rounded-4" placeholder="${await translate('nav.user')}" style="height: 3rem;"/>
