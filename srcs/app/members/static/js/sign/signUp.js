...
export class SignUp extends Component {
    ...
    connectedCallback() {
		...
		{
			document.getElementById("profile-img").src = "/static/media/profile_pictures/frank.svg";
	...
	<div class="d-flex align-self-center" id="sing-up-form">
		<div class="form-group flex-column d-flex row-gap-5">
			...
			<div class="position-relative d-flex align-self-center justify-content-center align-items-center rounded-circle bg-secondary p-2" id="addimg-btn" style="width: 10em; height: 10em; cursor:pointer;">
				<div>
					<img class="rounded-circle" id="profile-img" src="/static/media/profile_pictures/frank.svg" style="width: 10em; height: 10em; object-fit: cover; object-position: center;" />
				</div>
...
customElements.define("c-signup", SignUp);
